...
# SECURITY WARNING: update this when you have the domain name in production
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Example app static directory
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_USER') # email address used to send emails
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_PASSWORD') # email password
